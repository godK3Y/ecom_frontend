...
class ProductService {
  ...
  private mockProducts: Product[] = [
    {
      ...
      shortDescription:
        "Classic fit organic cotton t-shirt with superior comfort and durability",
      price: 89,
      originalPrice: 120,
      sku: "PCT-001",
      ...
      images: [
        ...
        {
          id: "2",
          url: "/placeholder.svg?height=600&width=600&text=T-Shirt+Back",
          alt: "T-Shirt Back View",
          order: 1,
        },
        {
          id: "3",
          url: "/placeholder.svg?height=600&width=600&text=T-Shirt+Side",
    ...
    },
    {
      ...
      shortDescription:
        "Modern minimalist sneakers with premium materials and all-day comfort",
      price: 159,
      sku: "MS-002",
      ...
      images: [
        ...
        {
          id: "5",
          url: "/placeholder.svg?height=600&width=600&text=Sneakers+Top",
    ...
    },
    {
      ...
      shortDescription:
        "Modern tailored blazer with classic elegance and contemporary fit",
      price: 299,
      originalPrice: 399,
      sku: "TB-003",
      ...
      images: [
        {
          id: "6",
          url: "/placeholder.svg?height=600&width=600&text=Blazer+Front",
          alt: "Blazer Front View",
          order: 0,
        },
        {
          id: "7",
          url: "/placeholder.svg?height=600&width=600&text=Blazer+Back",
          alt: "Blazer Back View",
          order: 1,
        },
      ],
      variants: [
    ...
    },
    {
      ...
      shortDescription:
        "Sustainable organic cotton denim with classic fit and premium quality",
      price: 129,
      sku: "ODJ-004",
      ...
      images: [
        {
          id: "8",
          url: "/placeholder.svg?height=600&width=600&text=Jeans+Front",
  ...
  private mockBrands: Brand[] = [
    ...
    },
    {
      ...
      name: "Classic Wear",
      slug: "classic-wear",
      description: "Timeless and elegant clothing",
    },
  ];
