...
const values = [
  {
    ...
    description: "Every product is crafted with meticulous attention to detail and the finest materials.",
  },
  {
    icon: Truck,
    title: "Fast & Free Shipping",
    description: "Complimentary shipping on all orders with express delivery options available.",
  },
  {
    icon: Shield,
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground">
                At KeyCommerce, we believe that exceptional style shouldn't compromise on comfort or sustainability. Our
                collections are thoughtfully designed to elevate your everyday moments while respecting our planet.
              </p>
            </div>
