    ...
    <section className="py-16 sm:py-24 bg-primary text-primary-foreground">
      <div className="container px-4">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          {isSubmitted ? (
            <div className="space-y-4">
              <div className="text-lg font-medium">Thank you for subscribing!</div>
              <p className="text-primary-foreground/80">You'll receive our latest updates and exclusive offers.</p>
            </div>
          ) : (
